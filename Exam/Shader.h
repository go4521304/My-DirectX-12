...
public:
	...
	virtual void AnimateObjects(float fTimeElapsed, CPlayer* player, CHeightMapTerrain* m_pTerrain);
...
public:
	...
	void SetObject(XMFLOAT3 position);
public:
	std::list<CBulletObject*> m_pObjects;
