...
public:
	...
	XMFLOAT3 GetVertexPos() { return m_xmf3Position; }
};
...
public:
	CDiffusedVertex* pVertices = NULL;
	UINT* pnIndices = NULL;
...
public:
	...
	CCubeMeshDiffused(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, float fWidth = 2.0f, float fHeight = 2.0f, float fDepth = 2.0f, BOOL bullet = FALSE);
