...
void CPlayer::Move(DWORD dwDirection, float fDistance, bool bUpdateVelocity)
{
	if (dwDirection)
	{
		...
		if (dwDirection & DIR_RIGHT) xmf3Shift = Vector3::Add(xmf3Shift, XMFLOAT3(1.0f, 0.0f, 0.0f), fDistance);	//m_xmf3Right
		if (dwDirection & DIR_LEFT) xmf3Shift = Vector3::Add(xmf3Shift, XMFLOAT3(1.0f, 0.0f, 0.0f), -fDistance);
